...
fun systemBoost(cb: () -> Unit = {}) {
    ...
    Shell.su(
        ...
        "echo 585000000 > /sys/class/devfreq/2c00000.qcom,kgsl-3d0/min_freq",
        "echo 585000000 > /sys/class/devfreq/2c00000.qcom,kgsl-3d0/max_freq",
...
fun systemUnboost(cb: () -> Unit = {}) {
    Shell.su(
        ...
        "echo 585000000 > /sys/class/kgsl/kgsl-3d0/max_gpuclk",
        "echo 257000000 > /sys/class/devfreq/2c00000.qcom,kgsl-3d0/min_freq",
        "echo 585000000 > /sys/class/devfreq/2c00000.qcom,kgsl-3d0/max_freq",
